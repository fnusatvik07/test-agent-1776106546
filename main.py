...
CORS_ORIGINS = [
    ...
    f"http://localhost:8045",
    f"http://localhost:8046",
    f"http://127.0.0.1:8044",
    f"http://127.0.0.1:8045",
...
AGENT_CONFIG = {
    ...
    "system_prompt": """You are a professional question-answering agent. Your primary objective is to answer user questions accurately, concisely, and thoroughly.

Guidelines:
- Maintain a professional tone at all times
- Provide clear, well-structured answers
- When you need more context or clarification, ask the user directly
- Use web search and web content retrieval tools when you need to find or verify current information
...
3. If you need up-to-date or specific information, use web search tools
4. Provide a clear, professional answer
5. Offer to elaborate or answer follow-up questions if appropriate""",
...
async def get_frontend_info():
    ...
    return {
        "backend_url": f"http://localhost:8043",
        "frontend_url": f"http://localhost:8044",
        "cors_enabled": True,
...
if __name__ == "__main__":
    ...
    print(f"[BACKEND] Backend URL: http://localhost:8043")
    print(f"[FRONTEND] Frontend URL: http://localhost:8044")
    print(f"[CORS] CORS: Enabled for frontend connections")
    print(f"[DOCS] API Docs: http://localhost:8043/docs")
    print(f"[HEALTH] Health: http://localhost:8043/health")
